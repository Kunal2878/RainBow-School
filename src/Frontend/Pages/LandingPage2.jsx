        ...
        <div className="container mx-auto sm:px-16 px-6 py-4 flex justify-between items-center">
          <div className="flex items-center">
            <div className="text-black font-bold text-2xl">
              Rainbow Senior Secondary School
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 md:pr-12">
            ...
            <p className="text-gray-600 mb-8 text-lg animate-slideUp">
              Rainbow Senior Secondary School is a technology-first school that is committed to
          ...
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/2 p-6">
              ...
              <p className="text-black-300 mb-8 max-w-lg">
                Rainbow Senior Secondary School is a technology-first school management platform that
      ...
      <footer className="bg-gray-800 text-white py-8 relative z-10">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Rainbow Senior Secondary School</h3>
          ...
          <div className="border-t border-gray-700 mt-8 pt-6 text-center text-gray-500">
            <p>© {new Date().getFullYear()} Rainbow Senior Secondary School. All rights reserved.</p>
