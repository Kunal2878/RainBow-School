          ...
          <div className="mx-auto flex size-full flex-col py-10 max-w-[496px]">
            ...
            <div>
              <div className="mb-12 space-y-4 text-left">
                ...
                <h2 className="mt-6 text-black">
                  Get Started with <span className="text-purpleColor">Rainbow Senior Secondary School </span>
                   🚀
                </h2>
                <p className="text-black-300">
                  <i>
                    Be the part of Rainbow Senior Secondary School! The perfect platform to shape the future
                    of education
                  </i>
                </p>
              </div>
            ...
            <div className="text-14-regular mt-20 flex justify-between pb-16 lg:pb-18">
              <p className="justify-items-end text-black-300 xl:text-left">
                © 2025 Rainbow Senior Secondary School. All rights reserved
              </p>
            </div>
          </div>
        </div>
