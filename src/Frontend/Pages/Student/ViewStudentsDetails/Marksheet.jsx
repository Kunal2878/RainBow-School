      ...
      >
        ...
        <div className="flex items-center bg-blue-100 p-4 rounded-t-lg">
          ...
          <div>
            ...
            <p className="text-black-300">Rainbow Senior Secondary School</p>
          </div>
        </div>
        ...
        <div className="mt-4 text-center text-sm text-black-100">
          <p>This report card was generated by Rainbow Senior Secondary School on {new Date().toLocaleDateString()}</p>
        </div>
      </div>
    </div>
  );
