    ...
    return (
      <div className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-center mb-10">Welcome to Rainbow Senior Secondary School</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
            <div>
              ...
              <p className="text-gray-600">
                Rainbow Senior Secondary School is committed to revolutionizing education by providing a comprehensive digital
            ...
            <div>
              <h2 className="text-3xl font-bold mb-4">Why Choose Rainbow Senior Secondary School?</h2>
